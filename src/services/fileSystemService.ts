...
export const startDownload = async ({
    ...
    try {
        ...
        console.log("result", result?.headers["Content-Type"]);
...
export const deleteDownloadedFile = async (localUri: string): Promise<void> => {
    try {
...
export const fileExists = async (localUri: string): Promise<boolean> => {
    try {
        const fileInfo = await FileSystem.getInfoAsync(localUri);
