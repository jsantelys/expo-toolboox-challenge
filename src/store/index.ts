...
function createStoreForUser(userId: string) {
    const persistConfig = {
        key: userId,
...
export const switchUserStorage = async (userId: string | null, userData?: any) => {
...
const storeChangeListeners: Set<() => void> = new Set();
